...
path( NumCitiesRemainingToBeVisited, RemainingKm, CurrentCity, CitiesAlreadyVisited, [CurrentCity1|Path] ):-
    ...
    append(CitiesAlreadyVisited, [CurrentCity1], CitiesAlreadyVisited1),
    path(NumCitiesRemainingToBeVisited1, RemainingKm1, CurrentCity1, CitiesAlreadyVisited1, Path).
